...
<head>
    ...
    <style>
        * {
        ...
        body {
            height: 100%;
            background: #55ffff url(../images/czback2.jpg) 50% 50% no-repeat;
        ...
        .logo {
            ...
            background: url(../images/zf.png) no-repeat 0 0px;
            transform: scale(1);
        }
...
<div class="dowebok">
    <form action="/recharge" method="post">
        ...
        <div class="form-item">
            <input id="username"  name="rechargeMoney" style="color: deepskyblue" type="text" autocomplete="off" placeholder="充值金额">
            <p style="color: red ;margin-left: 3px">${errorMsg}</p>
        </div>
        <div class="form-item">
            <button id="submit">充值</button>
        </div>
        <div class="reg-bar">
        </div>
    </form>
