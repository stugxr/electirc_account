...
<body>
            ...
            <div class="top_w3pvt_main container">
                ...
                <div class="inner-w3pvt-page-info">
                    <ol class="breadcrumb d-flex">
                        ...
                        <li class="breadcrumb-item active">余额管理</li>
                    </ol>
	...
	<section class="about py-5">
	    <div class="container p-md-5">
	        <h3 class="tittle-w3ls text-center">余额：${elatricMoney}元</h3>
			<p></p>
            <a href="http://localhost:8088/toCz"><button class="button">充值</button></a>
            <a href="http://localhost:8088/toTx"><button class="button" >提现</button></a>
        </div>
	</section>
	<!--//Cost-->
    <!--/services-->
